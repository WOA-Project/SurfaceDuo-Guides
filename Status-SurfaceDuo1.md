...
|-----------------------------------|----------------------------------------------------------------------------------------------------------------|---------------|
| ✏️ Surface Pen V2                 | Automatic Bluetooth Pairing, Bluetooth pairing (Unlike in Android). Full Pressure sensitivity support, tilt, hover, ink acceleration. Eraser and side buttons supported (remappable in the settings app). | ✅           |
| ✏️ Surface Pen V3                 | Automatic Bluetooth Pairing, Bluetooth pairing (Unlike in Android). Full Pressure sensitivity support, tilt, hover, ink acceleration. Eraser and side button supported (remappable in the settings app). | ✅           |
| ✏️ Surface Pen V4                 | Firmware Updates available within Windows (Unlike in Android), Automatic Bluetooth Pairing, Bluetooth pairing (Unlike in Android). Full Pressure sensitivity support, tilt, hover, ink acceleration. Eraser and side button supported (remappable in the settings app). | ✅           |
| ✏️ Surface Slim Pen               | Firmware Updates available within Windows (Unlike in Android), Automatic Bluetooth Pairing, Bluetooth pairing (Unlike in Android). Full Pressure sensitivity support, tilt, hover, ink acceleration. Eraser and side button supported (remappable in the settings app). | ✅           |
| ✏️ Surface Slim Pen 2             | Firmware Updates available within Windows (Unlike in Android), Automatic Bluetooth Pairing. Full Pressure sensitivity support, tilt, hover, ink acceleration. Eraser and side button supported (remappable in the settings app). Pressure settings configurable in the Surface App. Vibration support is unsupported by the hardware. | ✅           |
